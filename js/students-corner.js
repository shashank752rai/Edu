...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Content data will be loaded dynamically from the database
    ...
    async function loadContent(contentType, classNum, subject) {
        ...
        try {
            ...
            const response = await fetch(`admin/api/get_materials.php?class=${classNum}&subject=${subject}&type=${contentType}`);
